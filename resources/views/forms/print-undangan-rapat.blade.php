                ...
                <div class="col">
                    ...
                    <div class="pengenal">
                        <table>
                            <tr class="no">
                                <td>
                                    <p style="margin-top: 1px; margin-bottom: 1px;">No<span style="margin-left:35px;">: </span>{{$undanganRapat->nomor_urut . '/' . $undanganRapat->tujuan_surat . '/SU' . '/' . $undanganRapat->nama_proker . '/' . '/HMSI FTI-UNAND' . $undanganRapat->bulan_surat . '/' . \Carbon\Carbon::parse($undanganRapat->letter_date)->translatedFormat('Y')}}</p>
